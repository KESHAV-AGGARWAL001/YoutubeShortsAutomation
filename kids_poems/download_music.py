...
SEARCH_TERMS = {
    "upbeat": [
        ...
        "happy kazoo melody",
        "kids party music",
        "carnival children music",
        "circus music cheerful",
        "happy banjo kids",
        "tambourine clap kids",
        "joyful trumpet fanfare short",
        "kids adventure music",
        "happy acoustic guitar children",
        "fun percussion kids",
        "upbeat flute melody happy",
    ],
    "calm": [
        "lullaby music box",
        ...
        "music box slow melody",
        "soft strings lullaby baby",
        "rain sounds gentle music",
        "ocean waves calm melody",
        "meditation music children",
        "calm flute relaxing",
        "gentle kalimba melody",
        "soft celesta bedtime",
    ],
    "playful": [
        ...
        "silly sound effects music",
        "comedy cartoon soundtrack",
        "quirky xylophone funny",
        "kids game show music",
        "boing spring cartoon sound",
        "playful accordion melody",
        "squeaky toy music kids",
        "happy harmonica children",
        "tiptoe sneaky cartoon music",
        "bubbly synth kids melody",
        "mischievous pizzicato funny",
    ],
    "magical": [
        "magical fairy music",
        ...
        "underwater magical melody",
        "space ambient children",
        "twinkle stars music",
        "unicorn rainbow music",
        "crystal chime fantasy",
        "forest fairy ambient",
        "northern lights ambient",
        "magical wand sparkle sound",
        "elfin music box whimsical",
        "enchanted garden melody",
        "celestial choir gentle kids",
    ],
}
