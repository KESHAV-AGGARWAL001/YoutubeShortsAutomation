...
{{
  ...
  "hashtags": "#nextlevelmind_km #mentalstrength #motivation #mindset #quotes",
  "slides": [
    {{
      "slide_number": 1,
      "slide_type": "cover",
...
{{
  ...
  "hashtags": "#nextlevelmind_km #{category_key.replace('_', '')} #motivation #mindset #selfimprovement",
  "slides": [
    {{
      "slide_number": 1,
      "slide_type": "cover",
...
{{
  ...
  "total_slides": 8,
  "caption": "Instagram caption (150-200 chars)",
  "hashtags": "#nextlevelmind_km #{category_key.replace('_', '')} #motivation #storytime #mindset",
  "slides": [
    {{
      "slide_number": 1,
      "slide_type": "cover",
